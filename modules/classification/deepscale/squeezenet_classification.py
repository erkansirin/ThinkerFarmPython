...
def load_squeezenet_classification_network(self):
    ...
    print("ThinkerFarm : Loading DeepScale SqueezeNet Network")
    self.T.delete("1.0", tki.END)
    self.T.insert("1.0","ThinkerFarm : Loading DeepScale SqueezeNet Network")

    squeezenet_config_path = "models/classification/squeezenet/squeezenet_v1.1.prototxt"
    squeezenet_path = "models/classification/squeezenet/squeezenet_v1.1.caffemodel"

    squeezenet_labels_path  = "models/classification/squeezenet/squeezenet.names"
